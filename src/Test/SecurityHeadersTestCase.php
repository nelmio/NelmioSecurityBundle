...
/**
 * Base test case for verifying HTTP security headers.
 *
 * Provides assertion methods to verify presence and values of security headers
 * like CORP, COEP, COOP, CSP, HSTS, X-Frame-Options, etc.
 *
 * Usage:
 *
 * ```php
 * use Nelmio\SecurityBundle\Test\SecurityHeadersTestCase;
 *
 * class MyControllerTest extends SecurityHeadersTestCase
 * {
 ...
 * ```
 */
abstract class SecurityHeadersTestCase extends WebTestCase
{
    /**
     * @var KernelBrowser|null
     */
    protected static $securityClient;
    ...
    public static function assertCrossOriginResourcePolicy(
        ...
        self::assertThatForSecurityHeaders(new ResponseHasCrossOriginResourcePolicy($expected), $message);
    }
    ...
    public static function assertCrossOriginEmbedderPolicy(
        ...
        self::assertThatForSecurityHeaders(new ResponseHasCrossOriginEmbedderPolicy($expected), $message);
    }
    ...
    public static function assertCrossOriginOpenerPolicy(
        ...
        self::assertThatForSecurityHeaders(new ResponseHasCrossOriginOpenerPolicy($expected), $message);
    }
    ...
    public static function assertCspHeader(
        ...
        self::assertThatForSecurityHeaders(
    ...
    public static function assertFrameOptions(
        ...
        self::assertThatForSecurityHeaders(new ResponseHasFrameOptions($expected), $message);
    }
    ...
    {
        self::assertThatForSecurityHeaders(new ResponseHasContentTypeOptions(), $message);
    }
    ...
    public static function assertReferrerPolicy(
        ...
        self::assertThatForSecurityHeaders(new ResponseHasReferrerPolicy($expected), $message);
    }
    ...
    {
        static::$securityClient = parent::createClient($options, $server);

        return static::$securityClient;
    }

    private static function assertThatForSecurityHeaders(Constraint $constraint, string $message = ''): void
    {
        static::assertThat(self::getSecurityResponse(), $constraint, $message);
    }

    private static function getSecurityResponse(): Response
    {
        if (null === static::$securityClient) {
            static::fail('A client must be set to make assertions on it. Did you forget to call "createClient()"?');
        }

        return static::$securityClient->getResponse();
    }
}
