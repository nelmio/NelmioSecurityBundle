...
The NelmioSecurityBundle provides PHPUnit constraints and a base test case to help you test the security headers in your application.

## Installation

The test utilities are included in the bundle. You can extend the `SecurityHeadersTestCase` in your functional tests.
...
class HomepageTest extends SecurityHeadersTestCase
{
