...
class ContentSecurityPolicyListener implements EventSubscriberInterface
{
    ...
    public function __construct(DirectiveSet $report, DirectiveSet $enforce, $compatHeaders = true, $hosts = array())
    {
        $this->report = $report;
    ...
    public function onKernelResponse(FilterResponseEvent $e)
    {
        ...
        if (empty($this->hosts) || (!empty($this->hosts) && in_array($_SERVER['HTTP_HOST'], $this->hosts))) {
