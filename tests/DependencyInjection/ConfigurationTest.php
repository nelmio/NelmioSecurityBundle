...
class ConfigurationTest extends TestCase
{
    ...
    public function testCrossOriginIsolation(): void
    {
        ...
        $this->assertSame('credentialless', $config['cross_origin_isolation']['paths']['^/admin']['coep']['value']);
        $this->assertFalse($config['cross_origin_isolation']['paths']['^/admin']['coep']['report_only']);
        $this->assertNull($config['cross_origin_isolation']['paths']['^/admin']['coep']['report_to']);
        $this->assertSame('same-origin-allow-popups', $config['cross_origin_isolation']['paths']['^/admin']['coop']['value']);
        $this->assertFalse($config['cross_origin_isolation']['paths']['^/admin']['coop']['report_only']);
        $this->assertNull($config['cross_origin_isolation']['paths']['^/admin']['coop']['report_to']);
        ...
        $this->assertSame('unsafe-none', $config['cross_origin_isolation']['paths']['^/.*']['coep']['value']);
        $this->assertSame('unsafe-none', $config['cross_origin_isolation']['paths']['^/.*']['coop']['value']);
